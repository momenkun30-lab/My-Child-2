    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        img.onload = () => {
          ...
          // Use much lower quality JPEG to minimize payload size for proxy stability
          ...
          {image ? (
            ...
            >
              ...
              <button 
                ...
                className="absolute top-3 right-3 p-2 bg-black/50 backdrop-blur-md rounded-full text-white hover:bg-red-500/80 transition-colors"
              >
                <X size={16} />
              </button>
            </motion.div>
